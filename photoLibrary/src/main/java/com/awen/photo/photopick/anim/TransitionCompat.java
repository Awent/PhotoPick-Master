...
public class TransitionCompat {
    ...
    private static final long mAnimTime = 200;
    ...
    public TransitionCompat(final Activity activity,Bundle bundle) {
        mActivity = activity;
        mViewOptions = bundle.getSparseParcelableArray(ViewOptionsCompat.KEY_VIEW_OPTION_LIST);
    }
    ...
    public void finishAfterTransition() {
        ...
        if (viewOptions != null
            ...
            mActivity.finish();
            mActivity.overridePendingTransition(0, R.anim.image_pager_exit_animation);
        }
    }
