...
public class ViewOptionsCompat {
    ...
    public static Bundle makeScaleUpAnimation2(GridLayoutManager layoutManager, ArrayList<Photo> thumbnailList) {
        ...
        for (int i = 0; i < thumbnailList.size(); i++) {
            if (i >= firstVisibleItemPosition && i <= lastVisibleItemPosition) {
                ...
                if(childView != null) {
                    sparseArray.put(i, createViewOptions(childView, thumbnailList.get(i).getPath()));
                }
            }
        }
